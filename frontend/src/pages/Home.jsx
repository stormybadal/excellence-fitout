          ...
          <div className="rounded-3xl bg-gradient-to-r from-yellow-500 to-orange-500 p-8 md:p-12 text-white shadow-2xl">
            <div className="flex flex-col items-center justify-between gap-8 md:flex-row md:items-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href="tel:+971501234567" className="group inline-flex items-center justify-center rounded-lg border-2 border-white/30 bg-white/10 px-8 py-4 font-semibold text-white backdrop-blur-sm transition-all duration-300 hover:border-white/50 hover:bg-white/20">
