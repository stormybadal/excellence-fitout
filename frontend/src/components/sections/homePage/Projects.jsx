            ...
            <div className="relative mx-auto max-w-7xl px-4">
                ...
                <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    {projects.map((p, index) => (
                        <div key={p.id} className="group relative overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-gray-100 transition-all duration-300 hover:shadow-2xl hover:ring-yellow-200">
                            <div className="relative overflow-hidden">
                                ...
                                <div className="absolute top-4 left-4 rounded-full bg-white/90 px-3 py-1 text-xs font-medium text-gray-800 backdrop-blur-sm">
                                    {index % 3 === 0 ? 'Commercial' : index % 3 === 1 ? 'Residential' : 'Renovation'}
                                </div>
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-gray-600 mb-4">
                                    {index % 3 === 0
                                        ? 'Modern office space with cutting-edge design and premium finishes.'
                                        : index % 3 === 1
                                            ? 'Luxury residential renovation featuring custom joinery and elegant interiors.'
                                            : 'Complete home transformation with contemporary styling and smart solutions.'
                                    }
                                </p>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-4 text-sm text-gray-500">
                                        <div className="flex items-center">
                                            ...
                                            {index % 3 === 0 ? 'Business Bay' : index % 3 === 1 ? 'Dubai Marina' : 'Jumeirah'}
                                        </div>
                                        <div className="flex items-center">
                                            <svg className="mr-1 h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                                                <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                                            </svg>
                                            {index % 3 === 0 ? '3 months' : index % 3 === 1 ? '2 months' : '4 months'}
                                        </div>
                                    </div>
                ...
                <div className="mt-12 text-center">
                    <button className="group inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-yellow-500 to-orange-500 px-8 py-4 font-semibold text-black shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl">
